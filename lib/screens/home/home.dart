                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                              icon: Icon(
                                Icons.home, color: Color(0xFF707B81),
                              ),
                              onPressed: () {
                            ...
                            IconButton(
                                icon: FaIcon(FontAwesomeIcons.heart, color: Color(0xFF707B81),),
                                onPressed: () {
                            ...
                            IconButton(
                                icon: Icon(
                                  Icons.notifications_none_sharp, color: Color(0xFF707B81),
                                ),
                                onPressed: () {
                            ...
                            IconButton(
                                icon: Icon(
                                  Icons.person_outline, color: Color(0xFF707B81),
                                ),
                                onPressed: () {
...
class BNBCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.arcToPoint(Offset(size.width * 0.60, 40), radius: Radius.circular(20.0), clockwise: false);
